...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance = new GLAppearance("../../data/shaders/smoothstep_lights.vs", "../../data/shaders/smoothstep_lights.fs");
    ...
    light_source1._cone_angle = 10.0; // in degree
   ...
   // light_source2._cone_direction = glm::vec3(-1.0, 0.0, 0.0); // this must be aligned with the object and light position.
    ...
    material._specular_material = glm::vec3(1.0, 0.0, 0.0);
    ...
    GLSphere3D* sphere = new GLSphere3D(0.0, 0.0, 0.0, 10.0, 180, 100);
    sphere->setApperance(*apperance);
    sphere->init();
    
    
    
    material._diffuse_material = glm::vec3(0.2, 0.0, 1.0);
    material._ambient_material = glm::vec3(0.2, 0.0, 1.0);
